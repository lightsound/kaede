...
**追記(2026-08-13 — 差し戻し②根本対応 / 2026-08-14 #110 サルベージ)**:
首ボブは増幅制(マスター実測 ×4)を全廃し**処方制**(接地 = stand−1.5%・
通過 = +1.5%)へ。セル選定は台帳ループ窓内の接地アンカー+丸め四分位、
ボブ位相と手アンカー皮膚近接の lint ゲートを新設。これらの機械・規則は
PR #110(未マージでクローズ — 4x 移行と競合)からサルベージ済みで、
walk/carry シート本体の再鋳造は factory v2 レーンで行う。factory-yield
2026-08-13 の行と asset-factory.md 運転知見 22 を参照。
