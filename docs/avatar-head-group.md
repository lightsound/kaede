...
**追記(2026-08-13 — 差し戻し②根本対応)**: 首ボブは増幅制(マスター
実測 ×4)を全廃し**処方制**(接地 = stand−1.5%・通過 = +1.5%)へ。
セル選定は台帳ループ窓内の接地アンカー+丸め四分位、ボブ位相と
手アンカー皮膚近接の lint ゲートを新設。carry マスターは真の 2 歩
サイクル+腰前抱えの v3 に差し替え。factory-yield 2026-08-13 の行と
asset-factory.md 運転知見 20 を参照。
